...
Administrative units from geoBoundaries are downloaded to the 'tmp' directory. Individual GeoJSON files for each administrative level are downloaded first, and then a composite ESRI Shapefile is saved to the output directory.
