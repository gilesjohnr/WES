...
#  
#  sc <- WES::template_WES_standard_curve
#  head(sc)
#  
...
#  
#  result <- WES::calc_n_copies(ct_values = df$ct_value,
...
#  ddct <- merge(template_WES_data, ddct, by=c('location_id', 'sample_date', 'target_name'), all.x=T)
#  
