...
See below for an example of how to use the `WES` package to calculate these climatic variables for the locations and times of a set of sampling observations.
...
![](../figures/plot_climate_precip.png){width=100%}
...
![](../figures/plot_climate_temp.png){width=100%}
...
![](../figures/plot_climate_esi.png){width=100%}
...
![](../figures/plot_climate_river.png){width=100%}
...
![](../figures/dir_output_climate.png){width=100%}
